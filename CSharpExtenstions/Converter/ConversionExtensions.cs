...
namespace CSharpExtenstions.Converter
{
    public static class ConversionExtensions
    {
        ...
        public static int? ToIntDefaultNull(this string value)
        {
            int result;
            if (int.TryParse(value, out result))
            {
        ...
        #region long
        public static double ToKb(this long length)
        {

            //An F is used at the end. The F stands for float,
            //and this enables our numbers to be rounded off with some more precision
            return System.Convert.ToDouble((length / 1024f).ToString("0.00", CultureInfo.InvariantCulture.NumberFormat));
