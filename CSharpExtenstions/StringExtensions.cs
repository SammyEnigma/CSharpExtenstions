...
using CSharpExtenstions.Converter;
...
namespace CSharpExtenstions
{
    ...
    public static class StringExtensions
    {
        ...
        {
            string fileName = input.ToValidPathInternal(false, replacement);

            char[] custominvalidChars = new char[] { '\\', '/', ':', '*', '?', '"', '<', '>', '|' };
            foreach (var c in custominvalidChars)
            {
        ...
        public static string RemoveSpecialCharacters(this string s)
        {
            ...
            return Regex.Replace(s, @"[^\w\d]", "", RegexOptions.Compiled);
        }
        ...
        public static string ReplaceSpecialCharacters(this string s)
        {
            ...
            else
            {
                ...
                char[] replaceBy = new char[] { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l',
                                                        'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u','v','w','x','y','z',
                                                        '1','2','3','4','5','6'};

                for (int i = 0; i < specialCharacters.Length; i++)
                {
                    s = s.Replace(specialCharacters[i], replaceBy[i]);
                }
        ...
        public static string ToSafeFileName(this string s, string defaultFileName)
        {
            string tmp = ReplaceSpecialCharacters(s);
